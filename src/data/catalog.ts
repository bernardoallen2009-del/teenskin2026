...
export const products: Product[] = [
  {
    ...
    name: "Balance Cleanser",
    shortName: "Balance Cleanser",
    description:
      "Gel de limpeza equilibrante que remove oleosidade e protetor solar sem deixar a pele repuxada.",
    category: "limpeza",
    skinTypes: ["oleosa", "mista", "normal", "sensivel"],
    concerns: ["oleosidade", "poros", "sensibilidade"],
    ingredients: ["Aloe vera", "Glicerina", "Chá verde"],
    badges: ["Mais vendido", "Sem perfume"],
    price: 14.9,
    rating: 4.7,
    reviews: 126,
    popularity: 98,
    image: "/images/balance-cleanser-5.png",
    gallery: [
      "/images/balance-cleanser-5.png",
      "/images/balance-cleanser-2.png",
      "/images/balance-cleanser-3.png",
      "/images/balance-cleanser-4.png",
      "/images/balance-cleanser-1.png"
    ],
    sizes: ["150 ml", "50 ml"],
    isNew: false,
    featured: true,
  ...
  },
  {
    ...
    slug: "calm-cleanser",
    name: "Calm Cleanser",
    shortName: "Calm Cleanser",
    description:
      "Gel de limpeza confortável para pele seca ou sensível, pensado para limpar sem tirar conforto à barreira.",
    category: "limpeza",
    skinTypes: ["seca", "sensivel", "normal"],
    concerns: ["secura", "sensibilidade", "barreira"],
    ingredients: ["Camomila", "Glicerina", "Pantenol"],
    badges: ["Novo", "Sem perfume"],
    price: 15.9,
    rating: 4.7,
    reviews: 41,
    popularity: 86,
    image: "/images/calm-cleanser-5.png",
    gallery: [
      "/images/calm-cleanser-5.png",
      "/images/calm-cleanser-1.png",
      "/images/calm-cleanser-2.png",
      "/images/calm-cleanser-3.png",
      "/images/calm-cleanser-4.png"
    ],
    sizes: ["150 ml"],
    isNew: true,
    featured: false,
    usage: "Aplica na pele húmida, massaja suavemente e enxagua sem esfregar.",
    safetyNote: "Mantém a rotina simples se a pele estiver muito sensibilizada."
  },
  {
    id: "p-010",
    slug: "clear-cleanser",
    name: "Clear Cleanser",
    shortName: "Clear Cleanser",
    description:
      "Espuma de limpeza leve para pele oleosa ou com borbulhas, com acabamento fresco e sem sensação agressiva.",
    category: "limpeza",
    skinTypes: ["oleosa", "mista", "normal"],
    concerns: ["oleosidade", "poros", "borbulhas"],
    ingredients: ["Chá verde", "Zinco PCA", "Pantenol"],
    badges: ["Novo", "Vegan"],
    price: 15.9,
    rating: 4.6,
    reviews: 37,
    popularity: 84,
    image: "/images/clear-cleanser-5.png",
    gallery: [
      "/images/clear-cleanser-5.png",
      "/images/clear-cleanser-1.png",
      "/images/clear-cleanser-2.png",
      "/images/clear-cleanser-3.png",
      "/images/clear-cleanser-4.png"
    ],
    sizes: ["150 ml"],
    isNew: true,
    featured: false,
    usage: "Usa uma pequena quantidade, faz espuma nas mãos e massaja durante 30 a 45 segundos.",
    safetyNote: "Se a pele ficar seca ou irritada, alterna com uma limpeza mais suave."
  },
  {
    id: "p-002",
  ...
  {
    id: "p-007",
    slug: "hydra-body-lotion",
    name: "Hydra Body Lotion",
    shortName: "Hydra Lotion",
    description:
      "Loção corporal hidratante com textura rápida para braços, pernas e zonas ásperas.",
    category: "corpo",
    skinTypes: ["seca", "normal", "sensivel"],
    concerns: ["secura", "textura", "barreira"],
    ingredients: ["Aloe vera", "Glicerina", "Manteiga de karité"],
    badges: ["Sem perfume", "Cruelty-free"],
    price: 17.9,
    rating: 4.6,
    reviews: 73,
    popularity: 74,
    image: "/images/hydra-body-lotion-5.png",
    gallery: [
      "/images/hydra-body-lotion-5.png",
      "/images/hydra-body-lotion-1.png",
      "/images/hydra-body-lotion-2.png",
      "/images/hydra-body-lotion-3.png",
      "/images/hydra-body-lotion-4.png"
    ],
    sizes: ["250 ml"],
    isNew: false,
    featured: false,
